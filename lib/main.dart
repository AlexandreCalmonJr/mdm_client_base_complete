    ...
    try {
      ...
      if (await Permission.locationWhenInUse.request().isGranted) {
        ...
        if (wifiBSSID != null && 
          ...
          logger.info('MAC obtido via NetworkInfo: $macAddress');
          return macAddress;
        }
        ...
        try {
          ...
          if (result != null && 
            ...
            logger.info('MAC obtido via método nativo: $macAddress');
            return macAddress;
          }
        } catch (e) {
          logger.info('Erro ao obter MAC via método nativo: $e');
        }
        ...
        logger.info('MAC gerado via fingerprint: $macAddress');
        
      } else {
        logger.info('Permissão de localização não concedida');
        macAddress = 'Permission_Denied';
      }
      
    } catch (e) {
      logger.info('Erro ao obter MAC address: $e');
      macAddress = 'Error_$e';
    }
